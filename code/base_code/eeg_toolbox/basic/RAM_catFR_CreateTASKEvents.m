function events=RAM_catFR_CreateTASKEvents(subject,expDir,session,forceSESSION, startingElec)
%
% FUNCTION:
...
%         correct      = 0;
%   (3) Modified by isaac pedisich on 8/2014 (iped@sas.upenn.edu)
...
while true
    ...
    switch upper(thisTYPE)
        ...
        case {'B','E','SESS_END','ORIENT', 'STIM_ON', 'REC_END', 'DISTRACT_START', 'DISTRACT_END','SESSION_SKIPPED',...
           'COUNTDOWN_START','COUNTDOWN_END','PRACTICE_WORD','PRACTICE_DISTRACT_START','PRACTICE_DISTRACT_END',...
        ...
        case 'STIM_PARAMS'
            ...
            [AnodeNum, AnodeTag, CathodeNum, CathodeTag] = ...
                    getStimParams(subject, AnodeStr, CathodeStr, startingElec);
