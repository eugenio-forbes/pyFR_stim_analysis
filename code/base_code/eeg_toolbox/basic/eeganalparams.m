...
%
%   ~/iEEGDataBase/eeganalparams.txt
%
...
% in=fopen('/home/s163985/iEEGDataBase/eeganalparams.txt','rt');
if ismac 
    rootDir = '/Volumes';
else
    rootDir = '';
end
in=fopen(fullfile(rootDir,'/project/TIBIR/Lega_lab/shared/lega_ansir/shared_code/data_processing/iEEGDataBase/eeganalparams.txt'),'rt');
