function [bpTalStruct, hasMom] = getBipolarTalStructureFromVoxInfo_working(subj,doTalDaemon,source_subj)
%
% FUNCTION:
...
source_talDir = fullfile('/data/eeg',source_subj,'tal/talFiles_old');
...
if exist(fullfile(talDir,'bpPairs.mat'),'file')
    ...
    [allpairs, allTagNames, allGrpNames, allElecType] = getBipolarPairs_working(subj,source_subj);
end
