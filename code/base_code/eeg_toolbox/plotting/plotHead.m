...
% Set spline path
splinepath = fileparts(which('plotHead'));
% Old
%splinefile = fullfile(splinepath,'GSN129_splines');  

% Current
 splinefile = fullfile(splinepath,'HCGSN128.spl');  
...
% Current, HSCN
chans_to_remove = [43 48 49 56 63 68 73 81 88 94 99 107 113 119 126 120 121 125 17 127 128];
