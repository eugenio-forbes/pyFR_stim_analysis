...
ui8 RED_compress_block(const si4 *in_buffer, ui1 *out_buffer, ui4 num_entries, ui8 uUTC_time, ui1 discontinuity,
					   si1 *key, RED_BLOCK_HDR_INFO *block_hdr)
{
	ui4	cum_cnts[256], cnts[256], max_cnt, scaled_tot_cnts, extra_bytes;
	ui4	diff_cnts, comp_block_len, comp_len, encrypted_segments, checksum, update_crc_32();
